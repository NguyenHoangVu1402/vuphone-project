...
function displayAjaxLoading(n) {
    n ? ($(".ajax-loading-block-window").show(),
    $("body").addClass("loading-open")) : ($("body").removeClass("loading-open"),
    $(".ajax-loading-block-window").hide())
}
function displayPopupNotification(n, t, i) {
    var f, r, u, e;
    if (f = t == "success" ? $("#dialog-notifications-success") : t == "error" ? $("#dialog-notifications-error") : t == "warning" ? $("#dialog-notifications-warning") : $("#dialog-notifications-success"),
    r = "",
    typeof n == "string")
        r = "<p>" + n + "<\/p>";
    else
        ...
        for (i in n)
            if (n.hasOwnProperty(i))
                ...
                r = 0; r < e.length; ++r)
                    ...
                    t.innerHTML = e[r],
                    t.classList.add("popup-notification"),
                    t.classList.add(i),
                    f.append(t);
        u.html(f);
        u.dialog({
...
function displayBarNotification(n, t, i) {
    var c, o = typeof n == "string" ? [n] : n, s, r, u, f, e, h;
    if (o.length !== 0) {
        for (s = ["success", "error", "warning"].indexOf(t) !== -1 ? t : "success",
        $("#bar-notification").removeClass("success").removeClass("error").removeClass("warning"),
        $(".bar-notification").remove(),
        r = document.createElement("div"),
        r.classList.add("bar-notification", s),
        r.classList.add(s),
        u = document.createElement("span"),
        u.classList.add("close"),
        u.setAttribute("title", document.getElementById("bar-notification").dataset.close),
        f = 0; f < o.length; f++)
...
function(n) {
    ...
    function i(i) {
        var r = t.console;
        n.migrateDeduplicateWarnings && e[i] || (e[i] = !0,
    ...
    t.console && t.console.log && (n && u("3.0.0") || t.console.log("JQMIGRATE: jQuery 3.0.0+ REQUIRED"),
    ...
    var o, b, c, k = {}, st = n.fn.init, s = n.find, ht = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, ct = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, lt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
    for (o in n.fn.init = function(n) {
        var t = Array.prototype.slice.call(arguments);
        return "string" == typeof n && "#" === n && (i("jQuery( '#' ) is not a valid selector"),
        t[0] = []),
        st.apply(this, t)
    }
    ,
    ...
    r(n, "isFunction", function(n) {
        return "function" == typeof n
    }, "jQuery.isFunction() is deprecated"),
    r(n, "isWindow", function(n) {
    ...
    n.ajax = function() {
        ...
        return n.promise && (r(n, "success", n.done, "jQXHR.success is deprecated and removed"),
        r(n, "error", n.fail, "jQXHR.error is deprecated and removed"),
        r(n, "complete", n.always, "jQXHR.complete is deprecated and removed")),
        n
    }
    ,
    ...
    n.fn.removeAttr = function(t) {
        ...
        return n.each(t.match(yt), function(t, u) {
            n.expr.match.bool.test(u) && (i("jQuery.fn.removeAttr no longer sets boolean properties: " + u),
            r.prop(u, !1))
        }),
    ...
    var d, a = !(n.fn.toggleClass = function(t) {
        return void 0 !== t && "boolean" != typeof t ? vt.apply(this, arguments) : (i("jQuery.fn.toggleClass( boolean ) is deprecated"),
        this.each(function() {
    ...
    ), pt = /^[a-z]/, wt = /^(?:Border(?:Top|Right|Bottom|Left)?(?:Width|)|(?:Margin|Padding)?(?:Top|Right|Bottom|Left)?|(?:Min|Max)?(?:Width|Height))$/;
    ...
    n.swap = function(n, t, r, u) {
        var e, f, o = {};
        for (f in a || i("jQuery.swap() is undocumented and deprecated"),
        t)
            o[f] = n.style[f],
            n.style[f] = t[f];
        for (f in e = r.apply(n, u || []),
        t)
            n.style[f] = o[f];
        return e
    }
    ...
    u("3.4.0") && "undefined" != typeof Proxy && (n.cssProps = new Proxy(n.cssProps || {},{
        set: function() {
            return i("JQMIGRATE: jQuery.cssProps is deprecated"),
    ...
    n.fn.css = function(t, r) {
        ...
        this) : ("number" == typeof r && (f = l(t),
        u = f,
        pt.test(u) && wt.test(u[0].toUpperCase() + u.slice(1)) || n.cssNumber[f] || i('Number-typed values are deprecated for jQuery.fn.css( "' + t + '", value )')),
    ...
    n.data = function(t, r, u) {
        ...
        if (r && "object" == typeof r && 2 === arguments.length) {
            for (e in o = n.hasData(t) && f.call(this, t),
            s = {},
            r)
                e !== l(e) ? (i("jQuery.data() always sets/gets camelCased names: " + e),
                o[e] = r[e]) : s[e] = r[e];
            return f.call(this, t, s),
            r
        }
        return r && "string" == typeof r && r !== l(r) && (o = n.hasData(t) && f.call(this, t)) && r in o ? (i("jQuery.data() always sets/gets camelCased names: " + r),
        2 < arguments.length && (o[r] = u),
        o[r]) : f.apply(this, arguments)
    }
    ;
    n.fx && (g = n.Tween.prototype.run,
    nt = function(n) {
        return n
    }
    ,
    n.Tween.prototype.run = function() {
        1 < n.easing[this.easing].length && (i("'jQuery.easing." + this.easing.toString() + "' should use only one argument"),
    ...
    t.requestAnimationFrame && Object.defineProperty(n.fx, "interval", {
        configurable: !0,
        enumerable: !0,
        get: function() {
            return t.document.hidden || i(y),
            v
        },
        set: function(n) {
            i(y);
    ...
    n.event.fix = function(t) {
        ...
        if (r.length)
            for (i("jQuery.event.props are deprecated and removed: " + r.join()); r.length; )
                n.event.addProp(r.pop());
        if (u && !u._migrated_ && (u._migrated_ = !0,
        i("jQuery.event.fixHooks are deprecated and removed: " + e),
        (r = u.props) && r.length))
            while (r.length)
                n.event.addProp(r.pop());
        return f = dt.call(this, t),
        u && u.filter ? u.filter(f, t) : f
    }
    ,
    n.event.add = function(n, r) {
        return n === t && "load" === r && "complete" === t.document.readyState && i("jQuery(window).on('load'...) called after load event occurred"),
    ...
    n.each(["load", "unload", "error"], function(t, r) {
        n.fn[r] = function() {
            ...
            return "load" === r && "string" == typeof n[0] ? bt.apply(this, n) : (i("jQuery.fn." + r + "() is deprecated"),
            n.splice(0, 0, r),
            arguments.length ? this.on.apply(this, n) : (this.triggerHandler.apply(this, n),
            this))
        }
    }),
    n.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(t, r) {
        n.fn[r] = function(n, t) {
            return i("jQuery.fn." + r + "() event shorthand is deprecated"),
    ...
    n.fn.offset = function() {
        var n = this[0];
        return !n || n.nodeType && n.getBoundingClientRect ? ft.apply(this, arguments) : (i("jQuery.fn.offset() requires a valid DOM element"),
    ...
    n.param = function(t, r) {
        ...
        return void 0 === r && u && (i("jQuery.param() no longer uses jQuery.ajaxSettings.traditional"),
        r = u),
        ut.call(this, t, r)
    }
    ),
    ...
    ,
    n.Deferred && (w = n.Deferred,
    et = [["resolve", "done", n.Callbacks("once memory"), n.Callbacks("once memory"), "resolved"], ["reject", "fail", n.Callbacks("once memory"), n.Callbacks("once memory"), "rejected"], ["notify", "progress", n.Callbacks("memory"), n.Callbacks("memory")]],
...
t = function() {
            ...
            unbind: function(i, r, u) {
                t(i, r, function(t, i, r) {
                    n = n.filter(function(n) {
                        return !!(n[0] !== t || n[1] !== i || n[2] !== r || u && n[3] !== u) || (n[4](),
                        !1)
                    })
                })
            },
    ...
    function i(n) {
        var r = n ? n.event.bus : document.createDocumentFragment()
          , i = uf();
        return n && n.event.on(ef, i.destroy),
        fi(i, {
            bus: r,
            on: function(n, t) {
    ...
    function nr(n, t, i, r) {
        ...
        var o, f, s = Date.now, u = 0, e = !0, a = 0;
        return {
            start: function(t) {
                t || l();
                o = s() - (t ? u * n : 0);
    ...
    function to(r, u, e, o) {
        function ui() {
            var t = r.splides.map(function(n) {
                return n = n.splide.Components.Slides.getAt(u),
                n ? n.slide.id : ""
            }).join(" ");
        ...
        function ht() {
            ...
            i = !t && (!ct() || y),
            r.state.is([st, kt]) || n(o, wf, i || ""),
            n(vr(o, a.focusableNodes || ""), yt, i ? -1 : ""),
            et && n(o, yt, i ? -1 : 0),
            t !== du(o, eu) && (p(o, eu, t),
            g(t ? ve : ye, w)),
            t || document.activeElement !== o || (i = ut.Slides.getAt(r.index)) && ku(i.slide),
            p(o, ue, u === f - 1),
            p(o, fe, u === f + 1))
        }
        function ct() {
        ...
        var nt, d = i(r), rt = d.on, g = d.emit, at = d.bind, ut = r.Components, dt = r.root, a = r.options, gt = a.isNavigation, ni = a.updateOnMove, ft = a.i18n, ti = a.pagination, et = a.slideFocus, vt = ut.Direction.resolve, ii = l(o, "style"), pt = l(o, h), y = -1 < e, bt = ri(o, "." + be), w = {
            index: u,
            slideIndex: e,
            slide: o,
            container: bt,
            isClone: y,
            mount: function() {
                y || (o.id = dt.id + "-slide" + kr(u + 1),
                n(o, k, ti ? "tabpanel" : "group"),
                n(o, vi, ft.slide),
                n(o, h, pt || br(ft.slideLabel, [u + 1, r.length])));
                at(o, "click", t(g, ff, w));
            ...
            isWithin: function(n, t) {
                return n = f(n - u),
                (n = y || !a.rewind && !r.is(wt) ? n : tt(n, r.length - n)) <= t
            }
        };
        return w
    }
    ...
    function ho(n, r, u) {
        ...
        var o, e = r.Move, h = r.Controller, l = r.Scroll, s = r.Elements.list, a = t(c, s, "transition");
        return {
            mount: function() {
            ...
            start: function(t, i) {
                var r = e.toPosition(t, !0)
                  , c = e.getPosition()
                  , s = function(t) {
                    var f = u.rewindSpeed, i, r;
                    return n.is(pt) && f && (i = h.getIndex(!0),
                    r = h.getEnd(),
                    0 === i && r <= t || r <= i && 0 === t) ? f : u.speed
                }(t);
                1 <= f(r - c) && 1 <= s ? u.useScroll ? l.scroll(r, s, !1, i) : (a("transform " + s + "ms " + u.easing),
                e.translate(r, !0),
                o = i) : (e.jump(t),
                i())
            },
      ...
      , eo = Object.freeze({
        ...
        Media: function(n, t, i) {
            ...
            function l() {
                ...
                bu(i);
                a(f);
                i.destroy ? n.destroy("completely" === i.destroy) : t ? (h(!0),
                n.mount()) : r !== i.direction && n.refresh()
            }
            function a(t, r, f) {
                nt(i, t);
        ...
        Elements: function(t, r, f) {
            ...
            function ct(n) {
                ...
                n && function(n, t) {
                    if (yu(n.closest))
                        return n.closest(t);
                    for (var i = n; i && 1 === i.nodeType && !ii(i, t); )
                        i = i.parentElement;
                    return i
                }(n, "." + uu) === o ? n : void 0
            }
            ...
            var s, c, it, ut = i(t), g = ut.on, ft = ut.bind, o = t.root, at = f.i18n, nt = {}, tt = [], w = [], d = [];
            return fi(nt, {
                setup: et,
                mount: function() {
                    g(u, st);
        ...
        Slides: function(n, r, f) {
            ...
            return {
                ...
                add: function(n, i) {
                    o(n, function(n) {
                        var r, u, e;
                        pu(n = g(n) ? gu(n) : n) && ((r = v[i]) ? ar(n, r) : ti(tt, n),
                        a(n, f.classes.slide),
                        r = n,
                        u = t(l, li),
                        r = vr(r, "img"),
                        (e = r.length) ? r.forEach(function(n) {
        ...
        Layout: function(n, r, o) {
            ...
            function it(n) {
                ...
                (n || b.width !== t.width || b.height !== t.height) && (c(y, "height", function() {
                    var n = "";
                    return a && (si(n = ot(), "height or heightRatio is missing."),
                    n = "calc(" + n + " - " + w(!1) + " - " + w(!0) + ")"),
                    n
                }()),
                tt(h("marginRight"), ft(o.gap)),
                tt("width", o.autoWidth ? null : ft(o.fixedWidth) || (a ? "" : st())),
                tt("height", ft(o.fixedHeight) || (a ? o.autoHeight ? null : st() : ot()), !0),
                b = t,
                k(dr),
                v !== (v = vt()) && (p(d, oe, v),
                k("overflow", v)))
            ...
            function ct(n, t) {
                return n = nt(n || 0),
                n ? s(n.slide)[h("width")] + (t ? 0 : at()) : 0
            }
            function rt(n, t) {
                var i, n = nt(n);
                return n ? (n = s(n.slide)[h("right")],
                i = s(g)[h("left")],
                f(n - i) + (t ? 0 : at())) : 0
            }
            function lt(t) {
            ...
            var a, b, v, ut = (l = i(n)).on, yt = l.bind, k = l.emit, l = r.Slides, h = r.Direction.resolve, d = (r = r.Elements).root, y = r.track, g = r.list, nt = l.getAt, tt = l.style;
            return {
                mount: function() {
                    var i, r, n;
                    et();
                    yt(window, "resize load", (i = t(k, li),
                    n = nr(r || 0, i, null, 1),
                    function() {
                        n.isPaused() && n.start()
                    }
        ...
        Clones: function(n, t, r) {
            ...
            function k() {
                var u, i = r.clones;
                return n.is(wt) ? gt(i) && (i = (u = r[h("fixedWidth")] && t.Layout.slideSize(0)) && hi(s(v.track)[h("width")] / u) || r[h("autoWidth")] && n.length || 2 * r.perPage) : i = 0,
                i
            }
            var f, o = i(n), l = o.on, v = t.Elements, p = t.Slides, h = t.Direction.resolve, c = [];
            return {
                mount: w,
                destroy: b
            }
        ...
        Move: function(n, t, r) {
            ...
            function v(i, r) {
                n.is(yi) || (r = r ? i : function(i) {
                    var r, u;
                    return n.is(wt) && (r = lt(i),
                    u = r > t.Controller.getEnd(),
                    (r < 0 || u) && (i = y(i, u))),
                    i
                }(i),
                c(d, "transform", "translate" + a("X") + "(" + r + "px)"),
                i !== r && k(vf))
            }
            function y(n, t) {
                var r = n - w(t)
            ...
            function p(t, i) {
                var u = h(yt(t - 1) - (t = t,
                "center" === (u = r.focus) ? (tt() - nt(t, !0)) / 2 : +u * nt(t) || 0));
                return i ? (t = u,
                t = r.trimSpace && n.is(pt) ? ct(t, 0, h(rt(!0) - tt())) : t) : u
            }
            function l() {
                var n = a("left");
            ...
            var b, o = i(n), at = o.on, k = o.emit, g = n.state.set, nt = (o = t.Layout).slideSize, vt = o.getPadding, yt = o.totalSize, tt = o.listSize, rt = o.sliderSize, a = (o = t.Direction).resolve, h = o.orient, d = (o = t.Elements).list, ut = o.track;
            return {
                mount: function() {
                    b = t.Transition;
                    at([et, dr, e, u], ft)
                ...
                move: function(n, t, i, r) {
                    ...
                    n !== t && (u = i < n,
                    f = h(y(l(), u)),
                    u ? 0 <= f : f <= d[a("scrollWidth")] - s(ut)[a("width")]) && (ht(),
                    v(y(l(), i < n), !0));
                    g(st);
                    k(it, t, i, n);
                    b.start(t, function() {
        ...
        Controller: function(n, r, f) {
            ...
            function yt(t, i, r) {
                ...
                return ti() || a() ? ((u = function(t) {
                    if (nt && "move" === f.trimSpace && t !== o)
                        for (var i = b(); i === k(t, !0) && gi(t, 0, n.length - 1, !f.rewind); )
                            t < o ? --t : ++t;
                    return t
                }(t)) !== t && (i = t,
                t = u,
                r = !1),
                t < 0 || s < t ? t = v || !gi(0, t, i, !0) && !gi(s, i, t, !0) ? p ? r ? t < 0 ? -(h % c || c) : h : t : f.rewind ? t < 0 ? s : 0 : -1 : w(et(t)) : r && t !== i && (t = w(et(i) + (t < i ? -1 : 1)))) : t = -1,
                t
            }
            function ut(n) {
                return p ? (n + h) % h || 0 : n
            ...
            var s, h, v, c, y = i(n), ht = y.on, dt = y.emit, l = r.Move, b = l.getPosition, ni = l.getLimit, k = l.toPosition, ti = (y = r.Slides).isEnough, ii = y.getLength, d = f.omitEnd, p = n.is(wt), nt = n.is(pt), lt = t(rt, !1), at = t(rt, !0), o = f.start || 0, it = o;
            return {
                mount: function() {
                    vt();
                    ht([e, u, "ei"], vt);
                ...
                go: function(n, t, i) {
                    ...
                    bt() || -1 < (r = ut(n = function(n) {
                        var r = o, i, t;
                        return g(n) ? (t = n.match(/([+\-<>])(\d+)?/) || [],
                        i = t[1],
                        t = t[2],
                        "+" === i || "-" === i ? r = yt(o + +("" + i + (+t || 1)), o) : ">" === i ? r = t ? w(+t) : lt(!0) : "<" === i && (r = at(!0))) : r = p ? n : ct(n, 0, s),
                        r
                    }(n))) && (t || r !== o) && (ot(r),
                    l.move(n, r, it, i))
                },
        ...
        Arrows: function(r, f, o) {
            function at() {
                ...
                ei(l, i ? "" : "none"),
                a(l, it = fu + "--" + o.direction),
                i && (rt([et, ci, u, lt, "ei"], nt),
                ft(c, "click", t(yt, ">")),
                ft(s, "click", t(yt, "<")),
                nt(),
                n([s, c], ai, st.id),
                ot("arrows:mounted", s, c)));
                rt(e, wt)
            }
            function wt() {
                vt();
            ...
            function nt() {
                ...
                t = g.getPrev(),
                i = g.getNext(),
                f = -1 < t && u < t ? w.last : w.prev,
                u = -1 < i && i < u ? w.first : w.next,
                s.disabled = t < 0,
                c.disabled = i < 0,
                n(s, h, f),
                n(c, h, u),
                ot("arrows:updated", s, c, t, i))
            }
            var tt, it, y = i(r), rt = y.on, ft = y.bind, ot = y.emit, p = o.classes, w = o.i18n, k = f.Elements, g = f.Controller, d = k.arrows, st = k.track, l = d, s = k.prev, c = k.next, ct = {};
            return {
                arrows: ct,
                mount: at,
                destroy: vt,
        ...
        Autoplay: function(t, r, f) {
            function v() {
                d() && r.Slides.isEnough() && (s.start(!f.resetProgress),
                w = y = o = !1,
                nt(),
                k(hf))
            }
            ...
            function nt() {
                e && (p(e, ot, !o),
                n(e, h, f.i18n[o ? "play" : "pause"]))
            }
            function st(n) {
                n = r.Slides.getAt(n);
                s.set(n && +l(n.slide, io) || f.interval)
            }
            var y, w, a = i(t), tt = a.on, b = a.bind, k = a.emit, s = nr(f.interval, t.go.bind(t, ">"), function(n) {
                var t = rt.bar;
                t && c(t, "width", 100 * n + "%");
                k("autoplay:playing", n)
            }), d = s.isPaused, rt = r.Elements, ut = (a = r.Elements).root, e = a.toggle, ft = f.autoplay, o = "pause" === ft;
            return {
                mount: function() {
        ...
        Scroll: function(n, r, o) {
            function g(n, i, u, e, o) {
                var p, y = k(), u = (l(),
                !u || d && a() || (u = r.Layout.sliderSize(),
                p = wr(n) * u * di(f(n) / u) || 0,
                n = h.toPosition(r.Controller.toDest(n % u)) + p),
                tf(y, n, 1));
                v = 1;
            ...
            function ft(n, t, i, r) {
                var u = k()
                  , r = (n + (t - n) * (t = r,
                (n = o.easingFunc) ? n(t) : 1 - Math.pow(1 - t, 4)) - u) * v;
                ut(u + r);
                d && !i && a() && (v *= .6,
                f(r) < 10 && g(rt(a(!0)), 600, !1, c, !0))
            }
            function l() {
                s && s.cancel()
            }
            ...
            var s, c, y = i(n), p = y.on, w = y.emit, b = n.state.set, h = r.Move, k = h.getPosition, rt = h.getLimit, a = h.exceededLimit, ut = h.translate, d = n.is(pt), v = 1;
            return {
                mount: function() {
                    p(it, l);
                    p([e, u], tt)
        ...
        Drag: function(n, t, r) {
            ...
            function si(n) {
                ...
                i = n.target,
                f = r.noDrag,
                ii(i, "." + re + ", ." + fr) || f && ii(i, f) || !t && n.button || (h.isBusy() ? w(n, !0) : (l = t ? c : window,
                o = a.is([st, kt]),
                k = null,
                u(l, su, lt, bt),
                u(l, hu, at, bt),
            ...
            function lt(t) {
                ...
                a.is(6) || (a.set(6),
                it("drag"));
                t.cancelable && (o ? (b.translate(ut + y(t) / (v && n.is(pt) ? 5 : 1)),
                s = 200 < yt(t),
                i = v !== (v = ct()),
                (s || i) && vt(t),
                g = !0,
                it("dragging"),
                w(t)) : f(y(s = t)) > f(y(s, !0)) && (i = t,
                u = r.dragMinThreshold,
                e = dt(u),
                h = e && u.mouse || 0,
                e = (e ? u.touch : +u) || 10,
                o = f(y(i)) > (rt(i) ? e : h),
            ...
            function at(i) {
                ...
                ot(!1),
                d ? h.scroll(s, 0, r.snap) : n.is(yi) ? h.go(ei(wr(e)) < 0 ? u ? "<" : "-" : u ? ">" : "+") : n.is(pt) && v && u ? h.go(ct(!0) ? ">" : "<") : h.go(h.toDest(s), !0),
                ot(!0),
                w(i));
                ft(l, su, lt);
                ft(l, hu, at);
            ...
            var ut, p, k, d, o, g, nt, l, s = i(n), ri = s.on, it = s.emit, u = s.bind, ft = s.unbind, a = n.state, b = t.Move, ui = t.Scroll, h = t.Controller, c = t.Elements.track, ot = t.Media.reduce, fi = (s = t.Direction).resolve, ei = s.orient, ht = b.getPosition, ct = b.exceededLimit, v = !1;
            return {
                mount: function() {
                    u(c, su, sr, bt);
                    u(c, hu, sr, bt);
        ...
        Keyboard: function(n, t, r) {
            ...
            var f, u, o = i(n), s = o.on, a = o.bind, v = o.unbind, y = n.root, h = t.Direction.resolve;
            return {
                mount: function() {
                    c();
                    s(e, l);
            ...
            function g() {
                ...
                f.Slides.forEach(function(n) {
                    vr(n.slide, uo).forEach(function(t) {
                        var i = l(t, pi)
                          , r = l(t, or);
                        i === t.src && r === t.srcset || (i = e.classes.spinner,
                        i = ri(r = t.parentElement, "." + i) || ht("span", i, r),
                        o.push([t, n, i]),
                        t.src || ei(t, "none"))
                    })
                });
        ...
        Pagination: function(r, f, o) {
            ...
            function ni(n, t) {
                var r = c.length
                  ...
                  , f = tt()
                  , i = -1
                  , f = (u === bt(ir, !1, f) ? i = ++n % r : u === bt(tr, !1, f) ? i = (--n + r) % r : "Home" === u ? i = 0 : "End" === u && (i = r - 1),
                c[i]);
                f && (ku(f.button),
                wt(">" + i),
                w(t, !0))
            ...
            var s, ft, p = i(r), et = p.on, st = p.emit, ct = p.bind, dt = f.Slides, at = f.Elements, l = f.Controller, vt = l.hasFocus, pt = l.getIndex, wt = l.go, bt = f.Direction.resolve, g = at.pagination, c = [];
            return {
                items: c,
                mount: function f() {
                    var y, i;
                    ...
                    y) {
                        ...
                        for (a(s = g || ht("ul", b.pagination, at.track.parentElement), ft = er + "--" + tt()),
                        n(s, k, "tablist"),
                        n(s, h, p.select),
                        n(s, iu, tt() === rr ? "vertical" : ""),
                        i = 0; i < ut; i++) {
                            var w = ht("li", null, s)
                              , v = ht("button", {
                                "class": b.page,
        ...
        Wheel: function(n, t, r) {
            function o(i) {
                var o, s, h, c, e;
                i.cancelable && (o = (e = i.deltaY) < 0,
                s = yr(i),
                h = r.wheelMinThreshold || 0,
                c = r.wheelSleep || 0,
                f(e) > h && c < s - u && (n.go(o ? "<" : ">"),
                u = s),
                e = o,
                r.releaseWheel && !n.state.is(st) && -1 === t.Controller.getAdjacent(e) || w(i))
            }
            var e = i(n).bind
              , u = 0;
            return {
    ...
    return vt = function() {
        ...
        return n.mount = function(n, t) {
            var u = this
              , r = this.state
              , i = this.Components;
            return si(r.is([1, 7]), "Already mounted!"),
            r.set(1),
            this.i = i,
            this.r = t || this.r || (this.is(yi) ? so : ho),
            this.t = n || this.t,
            rt(fi({}, eo, this.t, {
                Transition: this.r
            }), function(n, t) {
        ...
        n.emit = function(n) {
            var t;
            return (t = this.event).emit.apply(t, [n].concat(d(arguments, 1))),
            this
        }
        ,
        n.add = function(n, t) {
...
(function(n) {
    ...
    function bt(t) {
        ...
        var u = t ? t.event.bus : document.createDocumentFragment()
          , i = vt();
        return t && t.event.on(wt, i.destroy),
        at(i, {
            bus: u,
            on: f,
            off: n(i.unbind, u),
    ...
    function k(n, t, i, r) {
        ...
        var e = Date.now, s, u = 0, h, f = !0, y = 0;
        return {
            start: p,
            rewind: w,
            pause: l,
    ...
    function fi(n, t, i) {
        ...
        function fi() {
            n.is(ni) || !u && i.autoScroll !== !1 && (u = k(0, ki),
            pi(),
            bi())
        }
        function ei() {
            ...
            d = void 0,
            si([v, p, w, y, b]),
            lt(tt, "mouseenter mouseleave focusin focusout"),
            lt(o, "click"))
        }
        function pi() {
        ...
        function ki() {
            ...
            i !== u ? (at(u),
            gi(d = vt())) : (h(!1),
            r.rewind && n.go(r.speed > 0 ? 0 : t.Controller.getEnd()));
            vi()
        }
        function di(t) {
            var i = r.speed || 1;
            return t += ai(i),
            n.is(gt) && (t = ui(t, wt(!1), wt(!0))),
            t
        }
        function gi(r) {
            var u = n.length
            ...
            t.Slides.update(),
            t.Pagination.update(),
            i.lazyLoad === "nearby" && t.LazyLoad.check())
        }
        function oi() {
            if (o) {
        ...
        var c = bt(n), g = c.on, si = c.off, l = c.bind, lt = c.unbind, a = t.Move, at = a.translate, vt = a.getPosition, hi = a.toIndex, wt = a.getLimit, ti = t.Controller, ci = ti.setIndex, li = ti.getIndex, ai = t.Direction.orient, o = t.Elements.toggle, ri = t.Live, tt = n.root, vi = kt(t.Arrows.update, 500), r = {}, u, f, it, rt, et, d;
        return {
            setup: yi,
            mount: fi,
            destroy: ei,
    ...
    var s = Array.isArray, l, a, g, nt, it, st, ht;
    n(u, "function");
    n(u, "string");
    n(u, "undefined");
    l = Object.keys;
    ...
    window.splide.Extensions.AutoScroll = fi)
});
...
!function(n) {
    ...
    function ft(n, t) {
        return function(n) {
            ...
            if (n) {
                ...
                return ("Object" === i && n.constructor && (i = n.constructor.name),
                "Map" === i || "Set" === i) ? Array.from(n) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? p(n, t) : void 0
            }
        }(n, t) || function() {
    ...
    function d(n, t) {
        ...
        try {
            ...
            if (t && ("function" == typeof t || "object" === u(t)) && (r = t.then,
            "function" == typeof r))
    ...
    function g(n, t) {
        "pending" === n._state && (n._state = "settled",
        n._data = t,
        h(ct, n))
    }
    function e(n, t) {
    ...
    function v(n, i) {
        var u = i.fetch
          ...
          , e = i.token
          , r = n;
        return "URLSearchParams"in window ? (r = new URL(n)).searchParams.set("token", e) : r = r + "?token=" + encodeURIComponent(e),
        r = r.toString(),
        new t(function(n, t) {
    ...
    function yt(n, r) {
        ...
        , f = r.document || f, h = w.bind(w, f, ["fa", "fab", "fas", "far", "fal", "fad", "fak"]), c = Object.keys(n.iconUploads || {}).length > 0, u, e;
        return n.autoA11y.enabled && o(h),
        u = [{
            id: "fa-main",
            addOn: void 0
        }],
    ...
    function pt(n, t) {
        ...
        t && t.detectingConflicts && t.detectionIgnoreAttr && i.setAttributeNode(document.createAttribute(t.detectionIgnoreAttr)),
        i
    }
    function wt(n, r) {
        r.autoA11y = n.autoA11y.enabled;
        "pro" === n.license && (r.autoFetchSvg = !0,
        r.fetchSvgFrom = n.baseUrl + "/releases/" + ("latest" === n.version ? "latest" : "v".concat(n.version)) + "/svgs",
        r.fetchUploadedSvgFrom = n.uploadsUrl);
        var u = [];
        ...
        u.push(new t(function(t, u) {
            v(s(n, {
                ...
                t(function(n, t) {
                    ...
                    return void 0 !== i && n.setAttribute("data-auto-a11y", i ? "true" : "false"),
                    r && (n.setAttributeNode(document.createAttribute("data-auto-fetch-svg")),
                    n.setAttribute("data-fetch-svg-from", t.fetchSvgFrom),
                    n.setAttribute("data-fetch-uploaded-svg-from", t.fetchUploadedSvgFrom)),
                    n
                }(u, r))
            }).catch(u)
        }
    ...
    function it(n) {
        var t, u = [], i = document, f = i.documentElement.doScroll, r = (f ? /^loaded|^c/ : /^loaded|^i|^c/).test(i.readyState);
    ...
    var l, ot = function() {}, b = "undefined" != typeof global && void 0 !== global.process && "function" == typeof global.process.emit, st = "undefined" == typeof setImmediate ? setTimeout : setImmediate, f = [], t;
    n.prototype = {
        constructor: n,
        _state: "pending",
        _then: null,
        ...
        then: function(n, t) {
            ...
            "rejected" === this._state && b && h(at, this)),
            "fulfilled" === this._state || "rejected" === this._state ? h(k, i) : this._then.push(i),
            i.then
        },
        "catch": function(n) {
    ...
    n.all = function(t) {
        ...
        return new n(function(n, i) {
            ...
            for (var u = [], e = 0, f, r = 0; r < t.length; r++)
                (f = t[r]) && "function" == typeof f.then ? f.then(o(r), i) : u[r] = f;
            e || n(u)
        }
        )
    }
    ...
    n.race = function(t) {
        ...
        return new n(function(n, i) {
            for (var r, u = 0; u < t.length; u++)
                (r = t[u]) && "function" == typeof r.then ? r.then(n, i) : n(r)
        }
        )
    }
    ;
        ...
        if (window.FontAwesomeKitConfig) {
            ...
            (function() {
                ...
                c.detectingConflicts && r && it(function() {
                    ...
                    var n = function(n, t) {
                        var i = document.createElement("script");
                        return t && t.detectionIgnoreAttr && i.setAttributeNode(document.createAttribute(t.detectionIgnoreAttr)),
                        i.src = s(n, {
...
function(n) {
    ...
    t.prototype.cleanUpRows = function() {
        var n, t = this;
        t.options.rows > 0 && (n = t.$slides.children().children(),
        n.removeAttr("style"),
    ...
    t.prototype.focusHandler = function() {
        ...
        t.$slider.off("focus.slick blur.slick").on("focus.slick", "*", function() {
            var i = n(this);
            setTimeout(function() {
                t.options.pauseOnFocus && i.is(":focus") && (t.focussed = !0,
                t.autoPlay())
            }, 0)
    ...
    t.prototype.getLeft = function(n) {
        ...
        e = -1,
        t.options.vertical === !0 && t.options.centerMode === !0 && (2 === t.options.slidesToShow ? e = -1.5 : 1 === t.options.slidesToShow && (e = -2)),
        ...
        u = 0),
        t.options.centerMode === !0 && t.slideCount <= t.options.slidesToShow ? t.slideOffset = t.slideWidth * Math.floor(t.options.slidesToShow) / 2 - t.slideWidth * t.slideCount / 2 : t.options.centerMode === !0 && t.options.infinite === !0 ? t.slideOffset += t.slideWidth * Math.floor(t.options.slidesToShow / 2) - t.slideWidth : t.options.centerMode === !0 && (t.slideOffset = 0,
    ...
    t.prototype.getNavigableIndexes = function() {
        ...
        for (n.options.infinite === !1 ? i = n.slideCount : (t = n.options.slidesToScroll * -1,
        r = n.options.slidesToScroll * -1,
    ...
    t.prototype.getSlideCount = function() {
        var f, i, r, u, t = this;
        return u = t.options.centerMode === !0 ? Math.floor(t.$list.width() / 2) : 0,
        r = t.swipeLeft * -1 + u,
    ...
    t.prototype.initADA = function() {
        ...
        null !== t.$dots && (t.$slides.not(t.$slideTrack.find(".slick-cloned")).each(function(i) {
            ...
            f !== -1) && (u = "slick-slide-control" + t.instanceUid + f,
            n("#" + u).length && n(this).attr({
                "aria-describedby": u
            }))
        }),
    ...
    t.prototype.initArrowEvents = function() {
        ...
        n.options.accessibility === !0 && (n.$prevArrow.on("keydown.slick", n.keyHandler),
    ...
    t.prototype.lazyLoad = function() {
        ...
        var u, f, i, r, t = this;
        if (t.options.centerMode === !0 ? t.options.infinite === !0 ? (i = t.currentSlide + (t.options.slidesToShow / 2 + 1),
        r = i + t.options.slidesToShow + 2) : (i = Math.max(0, t.currentSlide - (t.options.slidesToShow / 2 + 1)),
        r = 2 + (t.options.slidesToShow / 2 + 1) + t.currentSlide) : (i = t.options.infinite ? t.options.slidesToShow + t.currentSlide : t.currentSlide,
        ...
        "anticipated" === t.options.lazyLoad)
            for (var o = i - 1, s = r, h = t.$slider.find(".slick-slide"), c = 0; c < t.options.slidesToScroll; c++)
                ...
                s++;
        e(u);
        t.slideCount <= t.options.slidesToShow ? (f = t.$slider.find(".slick-slide"),
        e(f)) : t.currentSlide >= t.slideCount - t.options.slidesToShow ? (f = t.$slider.find(".slick-cloned").slice(0, t.options.slidesToShow),
        e(f)) : 0 === t.currentSlide && (f = t.$slider.find(".slick-cloned").slice(t.options.slidesToShow * -1),
        e(f))
    }
    ;
    ...
    t.prototype.postSlide = function(t) {
        ...
        i.options.accessibility === !0 && (i.initADA(),
        i.options.focusOnChange)) && (r = n(i.$slides.get(i.currentSlide)),
    ...
    t.prototype.progressiveLazyLoad = function(t) {
        t = t || 1;
        var r, u, e, o, f, i = this, s = n("img[data-lazy]", i.$slider);
        s.length ? (r = s.first(),
        u = r.attr("data-lazy"),
    ...
    t.prototype.removeSlide = t.prototype.slickRemove = function(n, t, i) {
        ...
        !(r.slideCount < 1 || n < 0 || n > r.slideCount - 1) && (r.unload(),
    ...
    t.prototype.setSlideClasses = function(n) {
        ...
        t.options.centerMode === !0) ? (e = t.options.slidesToShow % 2 == 0 ? 1 : 0,
        u = Math.floor(t.options.slidesToShow / 2),
        t.options.infinite === !0 && (n >= u && n <= t.slideCount - 1 - u ? t.$slides.slice(n - u + e, n + u + 1).addClass("slick-active").attr("aria-hidden", "false") : (r = t.options.slidesToShow + n,
    ...
    t.prototype.selectHandler = function(t) {
        ...
        return r || (r = 0),
        i.slideCount <= i.options.slidesToShow ? void i.slideHandler(r, !1, !0) : void i.slideHandler(r)
    }
    ;
    t.prototype.slideHandler = function(n, t, i) {
        var u, f, s, o, e, h = null, r = this;
        if (t = t || !1,
        !(r.animating === !0 && r.options.waitForAnimate === !0 || r.options.fade === !0 && r.currentSlide === n))
            return t === !1 && r.asNavFor(n),
            u = n,
            h = r.getLeft(u),
            o = r.getLeft(r.currentSlide),
            r.currentLeft = null === r.swipeLeft ? o : r.swipeLeft,
            r.options.infinite === !1 && r.options.centerMode === !1 && (n < 0 || n > r.getDotCount() * r.options.slidesToScroll) ? void (r.options.fade === !1 && (u = r.currentSlide,
            i !== !0 && r.slideCount > r.options.slidesToShow ? r.animateSlide(o, function() {
                r.postSlide(u)
            }) : r.postSlide(u))) : r.options.infinite === !1 && r.options.centerMode === !0 && (n < 0 || n > r.slideCount - r.options.slidesToScroll) ? void (r.options.fade === !1 && (u = r.currentSlide,
            i !== !0 && r.slideCount > r.options.slidesToShow ? r.animateSlide(o, function() {
                r.postSlide(u)
            ...
            void r.animateHeight()) : void (i !== !0 && r.slideCount > r.options.slidesToShow ? r.animateSlide(h, function() {
                r.postSlide(f)
            }) : r.postSlide(f)))
    }
    ;
    ...
    t.prototype.swipeDirection = function() {
        ...
        n <= 45 && n >= 0 ? t.options.rtl === !1 ? "left" : "right" : n <= 360 && n >= 315 ? t.options.rtl === !1 ? "left" : "right" : n >= 135 && n <= 225 ? t.options.rtl === !1 ? "right" : "left" : t.options.verticalSwiping === !0 ? n >= 35 && n <= 135 ? "down" : "up" : "vertical"
    }
    ;
    ...
    t.prototype.swipeMove = function(n) {
        ...
        !1) : (t.options.verticalSwiping === !0 && (t.touchObject.swipeLength = o),
        e = t.swipeDirection(),
...
function(n, t) {
    ...
    function c(n, t) {
        ...
        n !== i && t !== i || o.contains(s)) ? ui(i) ? i : u(i) : (f = p(n),
        f.host ? c(f.host, t) : c(n, p(t).host))
    }
    function f(n) {
    ...
    function b(n, i) {
        var y = a(), b = "HTML" === i.nodeName, f = w(n), p = w(i), c = s(n), e = r(i), l = parseFloat(e.borderTopWidth, 10), v = parseFloat(e.borderLeftWidth, 10), u = t({
            top: f.top - p.top - l,
            left: f.left - p.left - v,
            width: f.width,
            height: f.height
        }), o, h;
        return (u.marginTop = 0,
        u.marginLeft = 0,
        !y && b) && (o = parseFloat(e.marginTop, 10),
        h = parseFloat(e.marginLeft, 10),
        u.top -= l - o,
        u.bottom -= l - o,
        u.left -= v - h,
        u.right -= v - h,
        u.marginTop = o,
        u.marginLeft = h),
        (y ? i.contains(c) : i === c && "BODY" !== c.nodeName) && (u = fi(u, i)),
        u
    }
    function ei(n) {
    ...
    function vt(n, i, r) {
        ...
        return u.forEach(function(n) {
            ...
            n.enabled && ut(r) && (i.offsets.popper = t(i.offsets.popper),
    ...
    function ci() {
        ...
        yt(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
    ...
    function li(n, t, i, r) {
        ...
        var u = s(n);
        return bt(u, "scroll", i.updateBound, i.scrollParents),
        i.scrollElement = u,
        i.eventsEnabled = !0,
        i
    }
    ...
    function vi(n, t) {
        return wt(n).removeEventListener("resize", t.updateBound),
    ...
    function g(n, t) {
        Object.keys(t).forEach(function(i) {
            var r = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(i) && d(t[i]) && (r = "px");
            n.style[i] = t[i] + r
        })
    }
    function pi(n, t) {
    ...
    function bi(n, r, u, f) {
        ...
        return "vh" === e || "vw" === e ? (l = "vh" === e ? i(document.documentElement.clientHeight, window.innerHeight || 0) : i(document.documentElement.clientWidth, window.innerWidth || 0),
        l / 100 * o) : o
    }
    function ki(n, t, i, r) {
    ...
    var tt, gi = ni && window.Promise, nr = gi ? function(n) {
        var t = !1;
        return function() {
            t || (t = !0,
    ...
    , a = function() {
        return void 0 == tt && (tt = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        tt
    }, tr = function(n, t) {
        if (!(n instanceof t))
    ...
    , ri = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], it = ri.slice(3), rt = {
        FLIP: "flip",
        CLOCKWISE: "clockwise",
    ...
    v.Defaults = {
        ...
        modifiers: {
            ...
            preventOverflow: {
                ...
                enabled: !0,
                fn: function(t, r) {
                    var s = r.boundariesElement || u(t.instance.popper), e;
                    ...
                    var h = r.priority
                      ...
                      , c = {
                        primary: function(n) {
                            var t = f[n];
                            return f[n] < e[n] && !r.escapeWithReference && (t = i(f[n], e[n])),
                            o({}, n, t)
                        },
                        secondary: function(n) {
                            var t = "right" === n ? "left" : "top"
                              , i = f[t];
                            return f[n] > e[n] && !r.escapeWithReference && (i = gt(f[t], e[n] - ("right" === n ? f.width : f.height))),
                            o({}, t, i)
                        }
                    };
            ...
            keepTogether: {
                ...
                fn: function(n) {
                    var s = n.offsets
                      ...
                      , t = f ? "left" : "top"
                      , c = f ? "width" : "height";
                    return u[o] < r(i[t]) && (n.offsets.popper[t] = r(i[t]) - u[c]),
                    u[t] > r(i[o]) && (n.offsets.popper[t] = r(i[o])),
                    n
                }
            },
            arrow: {
                ...
                fn: function(n, u) {
                    var l, e;
                    if (!kt(n.instance.modifiers, "arrow", "keepTogether"))
                        return n;
                    if (e = u.element,
                    "string" == typeof e) {
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(t, i) {
                    if (yt(t.instance.modifiers, "inner") || t.flipped && t.placement === t.originalPlacement)
                        return t;
                    ...
                    return f.forEach(function(h, c) {
                        ...
                        tt && (u = wi(u)),
                        t.placement = r + (u ? "-" + u : ""),
                        t.offsets.popper = n({}, t.offsets.popper, at(t.instance.popper, t.offsets.reference, t.placement)),
                        t = vt(t.instance.modifiers, t, "flip"))
                    }),
                    t
                },
                behavior: "flip",
            ...
            inner: {
                ...
                fn: function(n) {
                    ...
                    return r[e ? "left" : "top"] = o[i] - (s ? r[e ? "width" : "height"] : 0),
                    n.placement = l(u),
                    n.offsets.popper = t(r),
                    n
                }
            },
            hide: {
                ...
                enabled: !0,
                fn: function(n) {
                    if (!kt(n.instance.modifiers, "hide", "preventOverflow"))
                        return n;
            ...
            computeStyle: {
                ...
                enabled: !0,
                fn: function(t, i) {
                    var g = i.x, nt = i.y, f = t.offsets.popper, l = h(t.instance.modifiers, function(n) {
                        return "applyStyle" === n.name
                    }).gpuAcceleration, b, k, d;
                    ...
                    var a, v, tt = void 0 === l ? i.gpuAcceleration : l, it = u(t.instance.popper), y = w(it), r = {
                        position: f.position
                    }, c = {
                        left: e(f.left),
                        top: e(f.top),
                        bottom: e(f.bottom),
                        right: e(f.right)
                    }, o = "bottom" === g ? "top" : "bottom", s = "right" === nt ? "left" : "right", p = pt("transform");
                    return (v = "bottom" == o ? -y.height + c.bottom : c.top,
                    a = "right" == s ? -y.width + c.right : c.left,
                    tt && p) ? (r[p] = "translate3d(" + a + "px, " + v + "px, 0)",
                    r[o] = 0,
                    r[s] = 0,
                    r.willChange = "transform") : (b = "bottom" == o ? -1 : 1,
                    k = "right" == s ? -1 : 1,
                    r[o] = v * b,
                    r[s] = a * k,
                    r.willChange = o + ", " + s),
            ...
            applyStyle: {
                ...
                enabled: !0,
                fn: function(n) {
                    return g(n.instance.popper, n.styles),
                    pi(n.instance.popper, n.attributes),
                    n.arrowElement && Object.keys(n.arrowStyles).length && g(n.arrowElement, n.arrowStyles),
                    n
                },
...
!function(n, t) {
        ...
        for (var u = (new window.DOMParser).parseFromString(n, "text/html"), e = Object.keys(t), f = [].slice.call(u.body.querySelectorAll("*")), o = function(n) {
            ...
            r.forEach(function(n) {
                (function(n, t) {
                    ...
                    if (-1 !== t.indexOf(i))
                        return -1 === si.indexOf(i) || Boolean(n.nodeValue.match(hi) || n.nodeValue.match(ci));
    ...
    var r = st(t), it = st(i), u = {
            ...
            for (r in i)
                if (Object.prototype.hasOwnProperty.call(i, r)) {
                    ...
                    if (!new RegExp(o).test(s))
                        throw new Error(n.toUpperCase() + ': Option "' + r + '" provided type "' + s + '" but expected type "' + o + '".');
                }
        },
        ...
        jQueryDetection: function() {
            ...
            if (n[0] < 2 && n[1] < 9 || 1 === n[0] && 9 === n[1] && n[2] < 1 || n[0] >= 4)
    ...
    var d = "alert"
      ...
      , l = function() {
        ...
        t._removeElement = function(n) {
            ...
            r.default(n).hasClass("fade")) ? (t = u.getTransitionDurationFromElement(n),
            r.default(n).one(u.TRANSITION_END, function(t) {
    ...
    a = function() {
        ...
        return t.toggle = function() {
            var t = !0, u = !0, f = r.default(this._element).closest('[data-toggle="buttons"]')[0], n, i;
            f && (n = this._element.querySelector('input:not([type="hidden"])'),
            n && ("radio" === n.type && (n.checked && this._element.classList.contains("active") ? t = !1 : (i = f.querySelector(".active"),
            i && r.default(i).removeClass("active"))),
            t && ("checkbox" !== n.type && "radio" !== n.type || (n.checked = !this._element.classList.contains("active")),
            this.shouldAvoidTriggerChange || r.default(n).trigger("change")),
            n.focus(),
            u = !1));
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (u && this._element.setAttribute("aria-pressed", !this._element.classList.contains("active")),
            t && r.default(this._element).toggleClass("active"))
        }
        ,
        t.dispose = function() {
    ...
    r.default(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(n) {
        var t = n.target, u = t, i;
        if (r.default(t).hasClass("btn") || (t = r.default(t).closest(".btn")[0]),
        !t || t.hasAttribute("disabled") || t.classList.contains("disabled"))
            n.preventDefault();
        else {
            if (i = t.querySelector('input:not([type="hidden"])'),
    ...
    r.default(window).on("load.bs.button.data-api", function() {
        for (var t, f, i, e, r, n = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), u = 0, o = n.length; u < o; u++)
            t = n[u],
            f = t.querySelector('input:not([type="hidden"])'),
            f.checked || f.hasAttribute("checked") ? t.classList.add("active") : t.classList.remove("active");
        for (i = 0,
        e = (n = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length; i < e; i++)
            r = n[i],
    ...
    var v = "carousel"
      ...
      , y = function() {
        ...
        n._getItemIndex = function(n) {
            return this._items = n && n.parentNode ? [].slice.call(n.parentNode.querySelectorAll(".carousel-item")) : [],
        ...
        n._getItemByDirection = function(n, t) {
            ...
            return (f && 0 === i || u && i === e) && !this._config.wrap ? t : (r = (i + ("prev" === n ? -1 : 1)) % this._items.length,
        ...
        n._triggerSlideEvent = function(n, t) {
            ...
            return r.default(this._element).trigger(i),
            i
        }
        ,
        n._setActiveIndicatorElement = function(n) {
            var i, t;
            this._indicatorsElement && (i = [].slice.call(this._indicatorsElement.querySelectorAll(".active")),
            r.default(i).removeClass("active"),
            t = this._indicatorsElement.children[this._getItemIndex(n)],
            t && r.default(t).addClass("active"))
        }
        ,
        n._updateInterval = function() {
            var t = this._activeElement || this._element.querySelector(".active.carousel-item"), n;
            t && (n = parseInt(t.getAttribute("data-interval"), 10),
        ...
        n._slide = function(n, t) {
            var e, o, s, c = this, f = this._element.querySelector(".active.carousel-item"), v = this._getItemIndex(f), i = t || f && this._getItemByDirection(n, f), y = this._getItemIndex(i), l = Boolean(this._interval), h, a;
            ("next" === n ? (e = "carousel-item-left",
            o = "carousel-item-next",
            s = "left") : (e = "carousel-item-right",
            o = "carousel-item-prev",
            s = "right"),
            i && r.default(i).hasClass("active")) ? this._isSliding = !1 : !this._triggerSlideEvent(i, s).isDefaultPrevented() && f && i && (this._isSliding = !0,
            l && this.pause(),
            this._setActiveIndicatorElement(i),
            this._activeElement = i,
            h = r.default.Event("slid.bs.carousel", {
                relatedTarget: i,
                direction: s,
                from: v,
                to: y
            }),
            r.default(this._element).hasClass("slide") ? (r.default(i).addClass(o),
            u.reflow(i),
            r.default(f).addClass(e),
            r.default(i).addClass(e),
            a = u.getTransitionDurationFromElement(f),
            r.default(f).one(u.TRANSITION_END, function() {
            ...
            }).emulateTransitionEnd(a)) : (r.default(f).removeClass("active"),
            r.default(i).addClass("active"),
            this._isSliding = !1,
        ...
        t._jQueryInterface = function(n) {
            return this.each(function() {
                var i = r.default(this).data("bs.carousel"), u = f({}, ft, r.default(this).data()), e;
                if ("object" == typeof n && (u = f({}, u, n)),
                e = "string" == typeof n ? n : u.slide,
                i || (i = new t(this,u),
                r.default(this).data("bs.carousel", i)),
                "number" == typeof n)
                    i.to(n);
                    ...
                    u.interval && u.ride && (i.pause(),
                    i.cycle())
            })
        }
        ,
        t._dataApiClickHandler = function(n) {
            var s = u.getSelectorFromElement(this), i, o, e;
            s && (i = r.default(s)[0],
            i && r.default(i).hasClass("carousel") && (o = f({}, r.default(i).data(), r.default(this).data()),
            e = this.getAttribute("data-slide-to"),
            e && (o.interval = !1),
            t._jQueryInterface.call(r.default(i), o),
            e && r.default(i).data("bs.carousel").to(e),
            n.preventDefault()))
        }
        ,
        e(t, null, [{
    ...
    r.default(window).on("load.bs.carousel.data-api", function() {
        for (var t, i = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), n = 0, u = i.length; n < u; n++)
            t = r.default(i[n]),
      ...
      , g = function() {
        function t(n, t) {
            ...
            for (var f = [].slice.call(document.querySelectorAll('[data-toggle="collapse"]')), i = 0, o = f.length; i < o; i++) {
                ...
                null !== r && s.length > 0 && (this._selector = r,
        ...
        n.show = function() {
            ...
            n && (e = r.default(n).not(this._selector).data("bs.collapse")) && e._isTransitioning) || (o = r.default.Event("show.bs.collapse"),
            (r.default(this._element).trigger(o),
            o.isDefaultPrevented()) || (n && (t._jQueryInterface.call(r.default(n).not(this._selector), "hide"),
            e || r.default(n).data("bs.collapse", null)),
            f = this._getDimension(),
            r.default(this._element).removeClass("collapse").addClass("collapsing"),
            this._element.style[f] = 0,
            this._triggerArray.length && r.default(this._triggerArray).removeClass("collapsed").attr("aria-expanded", !0),
        ...
        ,
        n.hide = function() {
            var s = this, i, n, f, t, e, o, h;
            if (!this._isTransitioning && r.default(this._element).hasClass("show") && (i = r.default.Event("hide.bs.collapse"),
            r.default(this._element).trigger(i),
            !i.isDefaultPrevented())) {
                if (n = this._getDimension(),
                this._element.style[n] = this._element.getBoundingClientRect()[n] + "px",
                u.reflow(this._element),
                r.default(this._element).addClass("collapsing").removeClass("collapse show"),
                f = this._triggerArray.length,
                f > 0)
                    for (t = 0; t < f; t++)
                        e = this._triggerArray[t],
                        o = u.getSelectorFromElement(e),
                        null !== o && (r.default([].slice.call(document.querySelectorAll(o))).hasClass("show") || r.default(e).addClass("collapsed").attr("aria-expanded", !1));
                this.setTransitioning(!0);
        ...
        ,
        n._getConfig = function(n) {
            return (n = f({}, et, n)).toggle = Boolean(n.toggle),
            u.typeCheckConfig(p, n, ti),
            n
        }
        ,
        ...
        n._getParent = function() {
            var n, e = this, i, f;
            return u.isElement(this._config.parent) ? (n = this._config.parent,
            ...
            f = [].slice.call(n.querySelectorAll(i)),
            r.default(f).each(function(n, i) {
        ...
        t._jQueryInterface = function(n) {
            return this.each(function() {
                ...
                if (!i && e.toggle && "string" == typeof n && /show|hide/.test(n) && (e.toggle = !1),
                i || (i = new t(this,e),
                u.data("bs.collapse", i)),
                "string" == typeof n) {
    ...
    var w = "dropdown"
      ...
      , o = function() {
        ...
        t.show = function(t) {
            var f;
            if (void 0 === t && (t = !1),
            !(this._element.disabled || r.default(this._element).hasClass("disabled") || r.default(this._menu).hasClass("show"))) {
                var e = {
                    relatedTarget: this._element
                }
                  , o = r.default.Event("show.bs.dropdown", e)
                  , i = n._getParentFromElement(this._element);
                if (r.default(i).trigger(o),
                !o.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        if ("undefined" == typeof it.default)
                            throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
                        f = this._element;
                        "parent" === this._config.reference ? f = i : u.isElement(this._config.reference) && (f = this._config.reference,
        ...
        t.hide = function() {
            if (!this._element.disabled && !r.default(this._element).hasClass("disabled") && r.default(this._menu).hasClass("show")) {
                ...
                r.default(this._menu).toggleClass("show"),
                r.default(u).toggleClass("show").trigger(r.default.Event("hidden.bs.dropdown", t)))
            }
        }
        ,
        t.dispose = function() {
        ...
        t._getConfig = function(n) {
            return n = f({}, this.constructor.Default, r.default(this._element).data(), n),
            u.typeCheckConfig(w, n, this.constructor.DefaultType),
            n
        }
        ,
        ...
        t._getPlacement = function() {
            var t = r.default(this._element.parentNode)
              , n = "bottom-start";
            return t.hasClass("dropup") ? n = r.default(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? n = "right-start" : t.hasClass("dropleft") ? n = "left-start" : r.default(this._menu).hasClass("dropdown-menu-right") && (n = "bottom-end"),
            n
        }
        ,
        ...
        n._jQueryInterface = function(t) {
            return this.each(function() {
                ...
                if (i || (i = new n(this,"object" == typeof t ? t : null),
                r.default(this).data("bs.dropdown", i)),
                "string" == typeof t) {
        ...
        n._clearMenus = function(t) {
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var u = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), i = 0, c = u.length; i < c; i++) {
                    ...
                    (t && "click" === t.type && (o.clickEvent = t),
                    e) && (h = e._menu,
                    !r.default(f).hasClass("show") || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && r.default.contains(f, t.target) || (s = r.default.Event("hide.bs.dropdown", o),
                    r.default(f).trigger(s),
                    s.isDefaultPrevented() || ("ontouchstart"in document.documentElement && r.default(document.body).children().off("mouseover", null, r.default.noop),
                    u[i].setAttribute("aria-expanded", "false"),
                    e._popper && e._popper.destroy(),
                    r.default(h).removeClass("show"),
                    r.default(f).removeClass("show").trigger(r.default.Event("hidden.bs.dropdown", o)))))
                }
        }
        ,
        ...
        n._dataApiKeydownHandler = function(t) {
            var f, e, u, i;
            if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || r.default(t.target).closest(".dropdown-menu").length) : !ri.test(t.which)) && !this.disabled && !r.default(this).hasClass("disabled") && (f = n._getParentFromElement(this),
            e = r.default(f).hasClass("show"),
            e || 27 !== t.which)) {
                if (t.preventDefault(),
                t.stopPropagation(),
                !e || 27 === t.which || 32 === t.which)
                    return 27 === t.which && r.default(f.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
                ...
                0 !== u.length && (i = u.indexOf(t.target),
                38 === t.which && i > 0 && i--,
                40 === t.which && i < u.length - 1 && i++,
                i < 0 && (i = 0),
                u[i].focus())
            }
        }
    ...
    var ei = r.default.fn.modal
      ...
      , nt = function() {
        ...
        n.show = function(n) {
            var t = this, i;
            this._isShown || this._isTransitioning || (r.default(this._element).hasClass("fade") && (this._isTransitioning = !0),
            i = r.default.Event("show.bs.modal", {
                relatedTarget: n
            }),
            r.default(this._element).trigger(i),
            ...
            r.default(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(n) {
                return t.hide(n)
            }),
        ...
        n.hide = function(n) {
            var e = this, t, i, f;
            (n && n.preventDefault(),
            this._isShown && !this._isTransitioning) && (t = r.default.Event("hide.bs.modal"),
            (r.default(this._element).trigger(t),
            this._isShown && !t.isDefaultPrevented()) && (this._isShown = !1,
            i = r.default(this._element).hasClass("fade"),
            ...
            i) ? (f = u.getTransitionDurationFromElement(this._element),
            r.default(this._element).one(u.TRANSITION_END, function(n) {
        ...
        n._getConfig = function(n) {
            return n = f({}, ot, n),
            u.typeCheckConfig("modal", n, oi),
            n
        }
        ,
        n._triggerBackdropTransition = function() {
            var n = this, f = r.default.Event("hidePrevented.bs.modal"), t, i;
            (r.default(this._element).trigger(f),
            f.isDefaultPrevented()) || (t = this._element.scrollHeight > document.documentElement.clientHeight,
        ...
        n._showElement = function(n) {
            var t = this, f = r.default(this._element).hasClass("fade"), e = this._dialog ? this._dialog.querySelector(".modal-body") : null, o, i, s;
            ...
            ;
            f ? (s = u.getTransitionDurationFromElement(this._dialog),
            r.default(this._dialog).one(u.TRANSITION_END, i).emulateTransitionEnd(s)) : i()
        }
        ,
        ...
        n._setEscapeEvent = function() {
            ...
            this._isShown ? r.default(this._element).on("keydown.dismiss.bs.modal", function(t) {
                n._config.keyboard && 27 === t.which ? (t.preventDefault(),
                n.hide()) : n._config.keyboard || 27 !== t.which || n._triggerBackdropTransition()
        ...
        n._showBackdrop = function(n) {
            var t = this, i = r.default(this._element).hasClass("fade") ? "fade" : "", e, f, o;
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"),
                this._backdrop.className = "modal-backdrop",
                i && this._backdrop.classList.add(i),
                r.default(this._backdrop).appendTo(document.body),
                r.default(this._element).on("click.dismiss.bs.modal", function(n) {
                ...
                !this._isShown && this._backdrop ? (r.default(this._backdrop).removeClass("show"),
                f = function() {
                    t._removeBackdrop();
                    n && n()
                }
                ,
                r.default(this._element).hasClass("fade") ? (o = u.getTransitionDurationFromElement(this._backdrop),
                r.default(this._backdrop).one(u.TRANSITION_END, f).emulateTransitionEnd(o)) : f()) : n && n()
        }
        ,
        ...
        n._setScrollbar = function() {
            ...
            f = r.default(document.body).css("padding-right"),
            r.default(document.body).data("padding-right", u).css("padding-right", parseFloat(f) + this._scrollbarWidth + "px"));
            r.default(document.body).addClass("modal-open")
        }
        ,
        n._resetScrollbar = function() {
            var i = [].slice.call(document.querySelectorAll(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top")), n, t;
        ...
        t._jQueryInterface = function(n, i) {
            return this.each(function() {
                ...
                if (u || (u = new t(this,e),
                r.default(this).data("bs.modal", u)),
                "string" == typeof n) {
    ...
    r.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(n) {
        var t, i = this, e = u.getSelectorFromElement(this), o, s;
    ...
    var s = "tooltip"
      ...
      , h = function() {
        ...
        n.toggle = function(n) {
            if (this._isEnabled)
                if (n) {
                    ...
                    t || (t = new this.constructor(n.currentTarget,this._getDelegateConfig()),
                    r.default(n.currentTarget).data(i, t));
        ...
        ,
        n.show = function() {
            var t = this, i, f, h, n, e, c, o, l, s, a;
            if ("none" === r.default(this.element).css("display"))
                throw new Error("Please use show on visible elements");
            if (i = r.default.Event(this.constructor.Event.SHOW),
            this.isWithContent() && this._isEnabled) {
                if (r.default(this.element).trigger(i),
                f = u.findShadowRoot(this.element),
                h = r.default.contains(null !== f ? f : this.element.ownerDocument.documentElement, this.element),
                i.isDefaultPrevented() || !h)
                    return;
                ...
                ;
                r.default(this.tip).hasClass("fade") ? (a = u.getTransitionDurationFromElement(this.tip),
                r.default(this.tip).one(u.TRANSITION_END, s).emulateTransitionEnd(a)) : s()
            }
        }
        ,
        n.hide = function(n) {
            var t = this, i = this.getTipElement(), f = r.default.Event(this.constructor.Event.HIDE), e = function() {
            ...
            (r.default(this.element).trigger(f),
            f.isDefaultPrevented()) || ((r.default(i).removeClass("show"),
            ...
            r.default(this.tip).hasClass("fade")) ? (o = u.getTransitionDurationFromElement(i),
            r.default(i).one(u.TRANSITION_END, e).emulateTransitionEnd(o)) : e(),
            this._hoverState = "")
        }
        ,
        n.update = function() {
        ...
        n.setElementContent = function(n, t) {
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = at(t, this.config.whiteList, this.config.sanitizeFn)),
            n.html(t)) : n.text(t) : this.config.html ? r.default(t).parent().is(n) || n.empty().append(t) : n.text(r.default(t).text())
        }
        ,
        n.getTitle = function() {
        ...
        n._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t)
                    r.default(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(t) {
                        return n.toggle(t)
                    });
                else if ("manual" !== t) {
        ...
        n._enter = function(n, t) {
            var i = this.constructor.DATA_KEY;
            (t = t || r.default(n.currentTarget).data(i)) || (t = new this.constructor(n.currentTarget,this._getDelegateConfig()),
            r.default(n.currentTarget).data(i, t));
            n && (t._activeTrigger["focusin" === n.type ? "focus" : "hover"] = !0);
            r.default(t.getTipElement()).hasClass("show") || "show" === t._hoverState ? t._hoverState = "show" : (clearTimeout(t._timeout),
            t._hoverState = "show",
        ...
        n._getConfig = function(n) {
            ...
            u.typeCheckConfig(s, n, this.constructor.DefaultType),
            n.sanitize && (n.template = at(n.template, n.whiteList, n.sanitizeFn)),
            n
        }
        ,
        ...
        n._fixTransition = function() {
            ...
            null === n.getAttribute("x-placement") && (r.default(n).removeClass("fade"),
        ...
        t._jQueryInterface = function(n) {
            return this.each(function() {
                var u = r.default(this)
                  , i = u.data("bs.tooltip")
                  , f = "object" == typeof n && n;
                if ((i || !/dispose|hide/.test(n)) && (i || (i = new t(this,f),
                u.data("bs.tooltip", i)),
                "string" == typeof n)) {
                    if ("undefined" == typeof i[n])
                        throw new TypeError('No method named "' + n + '"');
    ...
    var b = "popover"
      ...
      , rt = function(n) {
        ...
        var u, f, t;
        return f = n,
        (u = i).prototype = Object.create(f.prototype),
        ...
        t.setContent = function() {
            var t = r.default(this.getTipElement()), n;
        ...
        i._jQueryInterface = function(n) {
            return this.each(function() {
                ...
                if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this,u),
      ...
      , tt = function() {
        ...
        return n.refresh = function() {
            ...
            [].slice.call(document.querySelectorAll(this._selector)).map(function(n) {
                var i, e = u.getSelectorFromElement(n), o;
                return (e && (i = document.querySelector(e)),
                i) && (o = i.getBoundingClientRect(),
                o.width || o.height) ? [r.default(i)[t]().top + f, e] : null
            }).filter(function(n) {
                return n
            }).sort(function(n, t) {
                return n[0] - t[0]
        ...
        n._getConfig = function(n) {
            if ("string" != typeof (n = f({}, vt, "object" == typeof n && n ? n : {})).target && u.isElement(n.target)) {
                ...
                t || (t = u.getUID(c),
                r.default(n.target).attr("id", t));
                n.target = "#" + t
            }
            return u.typeCheckConfig(c, n, rr),
            n
        }
        ,
        ...
        t._jQueryInterface = function(n) {
            return this.each(function() {
                ...
                r.default(this).data("bs.scrollspy", i)),
                "string" == typeof n) {
                    if ("undefined" == typeof i[n])
                        throw new TypeError('No method named "' + n + '"');
                    i[n]()
    ...
    r.default(window).on("load.bs.scrollspy.data-api", function() {
        for (var i, n = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), t = n.length; t--; )
            i = r.default(n[t]),
    ...
    k = function() {
        ...
        return t.show = function() {
            var h = this, i, n, t, f, c, e, o, s;
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && r.default(this._element).hasClass("active") || r.default(this._element).hasClass("disabled") || (t = r.default(this._element).closest(".nav, .list-group")[0],
            f = u.getSelectorFromElement(this._element),
            t && (c = "UL" === t.nodeName || "OL" === t.nodeName ? "> li > .active" : ".active",
            n = (n = r.default.makeArray(r.default(t).find(c)))[n.length - 1]),
            e = r.default.Event("hide.bs.tab", {
                relatedTarget: this._element
            }),
            o = r.default.Event("show.bs.tab", {
                relatedTarget: n
            }),
            (n && r.default(n).trigger(e),
            r.default(this._element).trigger(o),
            o.isDefaultPrevented() || e.isDefaultPrevented()) || (f && (i = document.querySelector(f)),
        ...
        t._activate = function(n, t, i) {
            var s = this, f = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? r.default(t).children(".active") : r.default(t).find("> li > .active"))[0], h = i && f && r.default(f).hasClass("fade"), e = function() {
                return s._transitionComplete(n, f, i)
            }, o;
            f && h ? (o = u.getTransitionDurationFromElement(f),
            r.default(f).removeClass("show").one(u.TRANSITION_END, e).emulateTransitionEnd(o)) : e()
        }
        ,
        t._transitionComplete = function(n, t, i) {
            var f, e, o;
            t && (r.default(t).removeClass("active"),
            f = r.default(t.parentNode).find("> .dropdown-menu .active")[0],
            f && r.default(f).removeClass("active"),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1));
            (r.default(n).addClass("active"),
            "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !0),
            u.reflow(n),
            n.classList.contains("fade") && n.classList.add("show"),
            n.parentNode && r.default(n.parentNode).hasClass("dropdown-menu")) && (e = r.default(n).closest(".dropdown")[0],
            e && (o = [].slice.call(e.querySelectorAll(".dropdown-toggle")),
    ...
    var ur = r.default.fn.toast
      ...
      , ut = function() {
        ...
        return n.show = function() {
            var n = this, i = r.default.Event("show.bs.toast"), t, f;
            (r.default(this._element).trigger(i),
            ...
            this._config.animation) ? (f = u.getTransitionDurationFromElement(this._element),
            r.default(this._element).one(u.TRANSITION_END, t).emulateTransitionEnd(f)) : t())
        }
        ,
        n.hide = function() {
        ...
        ,
        n._getConfig = function(n) {
            return n = f({}, pt, r.default(this._element).data(), "object" == typeof n && n ? n : {}),
            u.typeCheckConfig("toast", n, this.constructor.DefaultType),
            n
        }
        ,
        n._setListeners = function() {
        ...
        n._close = function() {
            ...
            this._config.animation) ? (i = u.getTransitionDurationFromElement(this._element),
            r.default(this._element).one(u.TRANSITION_END, t).emulateTransitionEnd(i)) : t()
        }
        ,
    ...
    function() {
        ...
        n.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t, i) {
            n.fx.step[i] = function(n) {
                ("none" === n.end || n.setAttr) && (1 !== n.pos || n.setAttr) || (y.style(n.elem, i, n.end),
                n.setAttr = !0)
            }
        });
...
+function(n) {
    "use strict";
    function t() {
        var t = n(this), u = t.val(), i = n(t.data("stateprovince")), r;
        i.length != 0 && (r = n(t.data("loading")),
        r.show(),
        n.ajax({
            cache: !1,
            type: "GET",
    ...
    function i() {
        var f = n(this), h = f.val(), t = n(f.data("county")), u, e, i, r, o, s;
        states && states.length != 0 && t.length != 0 && (u = states.find(n => n.id == h),
        u) && (e = u.bkcId,
        i = [],
        showrooms) && (n("#receive_home")[0].checked ? i = provinces : (r = [],
        n.each(showrooms, function(n, t) {
            r.indexOf(t.QuanHuyenId) < 0 && r.push(t.QuanHuyenId)
        }),
        i = provinces.filter(n => r.includes(n.QuanHuyenId))),
        i) && (o = i.filter(n => n.TinhThanhId == e),
        t.html(""),
        t.append(n("<option><\/option>").val(0).html("Mời bạn chọn quận/huyện")),
        n.each(o, function(i, r) {
            t.append(n("<option><\/option>").val(r.QuanHuyenId).html(r.Name))
        }),
        s = typeof Billing != "undefined" ? Billing.selectedCountyId : typeof CheckoutBilling != "undefined" ? CheckoutBilling.selectedCountyId : 0,
        n("#" + t[0].id + " option[value=" + s + "]").prop("selected", !0))
    }
    function r() {
        var r = n(this), u = r.val(), t = n("#js__apply_now"), i;
        t.length != 0 && showrooms && (i = showrooms.filter(n => n.QuanHuyenId == u),
        i) && (n("#show_more_button").hide(),
        t.html(""),
    ...
    function u() {
        ...
        t.length != 0 && showrooms && (i = showrooms.filter(n => n.QuanHuyenId == u),
        i) && (t.html(""),
        t.append(n("<option><\/option>").val("").html("Mời bạn chọn địa chỉ cửa hàng")),
        n.each(i, function(i, r) {
